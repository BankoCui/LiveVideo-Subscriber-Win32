...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-shared --disable-swresample --disable-avresample --enable-swscale --disable-avformat --disable-avfilter --disable-pthreads --disable-ffprobe --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-network --disable-doc --disable-debug --disable-symver --disable-postproc --disable-stripping --disable-iconv --enable-small --enable-version3 --enable-gpl --enable-libx264 --enable-encoder=libx264 --enable-decoder=h264 --enable-parser=h264 --enable-decoder=hevc --enable-static --enable-memalign-hack --cpu=i686 --extra-cflags=-fno-common --extra-cflags=-I/e/VisualCpp2010Project/Win32ConsoleProject/VideoCodec/VideoCodec/third_party/ffmpeg/ffmpeg-2.6.4-win32/ffmpeg-2.6.4/x264/include --extra-ldflags=-L/e/VisualCpp2010Project/Win32ConsoleProject/VideoCodec/VideoCodec/third_party/ffmpeg/ffmpeg-2.6.4-win32/ffmpeg-2.6.4/x264/lib --prefix=/e/VisualCpp2010Project/Win32ConsoleProject/VideoCodec/VideoCodec/third_party/ffmpeg/ffmpeg-2.6.4-win32/ffmpeg-2.6.4/xiaohang/ffmpeg-2.6.4/
prefix=/e/VisualCpp2010Project/Win32ConsoleProject/VideoCodec/VideoCodec/third_party/ffmpeg/ffmpeg-2.6.4-win32/ffmpeg-2.6.4/xiaohang/ffmpeg-2.6.4/
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -L/e/VisualCpp2010Project/Win32ConsoleProject/VideoCodec/VideoCodec/third_party/ffmpeg/ffmpeg-2.6.4-win32/ffmpeg-2.6.4/x264/lib  -Wl,--nxcompat -Wl,--dynamicbase -Wl,--large-address-aware -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
...
EXTRALIBS=-lavicap32 -lgdi32 -Le:/VisualCpp2010Project/Win32ConsoleProject/VideoCodec/VideoCodec/third_party/ffmpeg/ffmpeg-2.6.4-win32/ffmpeg-2.6.4/x264/lib -lx264 -lm -lpsapi -ladvapi32 -lshell32 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=i386
...
avfilter_FFLIBS=swscale avcodec avutil
